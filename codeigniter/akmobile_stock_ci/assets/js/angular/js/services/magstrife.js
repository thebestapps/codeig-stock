/**
 * Implemented by henry on 10/26/2015.
 */
// /////////////////////////////////////////////////////////////////////////////////
...
function ParseParserObj()
{
    ...
    document.getElementById('card_number').value = p.account
    document.getElementById('card_holder').value = p.account_name;
    document.getElementById('card_expdate').value = p.exp_month + "/" + p.exp_year;
