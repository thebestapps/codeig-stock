<jqx-window jqx-on-close="close()" id="NumPadWindow" jqx-create="POSNumpaddialog" jqx-settings="POSNumpaddialog" style="display:none;">
         <div class="numpad-container">
           <?php /*?> <div id="KitchenNumPadTitle"></div><?php */?>
           <form id="DefaultFormID" class="custom-input">
            <div class="custom-numpad-input">
                ...
                <div class="kitchen-numpad-carrier">
                 	<div class="col-md-12">
                        <div class="col-md-3 hdcols">
                            <li class="button-no" ng-click="NumPad.NumPad = NumPad.NumPad + '' + 7">7</li>
                        ...
                        <div class="col-md-3 hdcols">
                            <button type="button" class="btn-fn" ng-click="NumpadCancel()">Cancel</button>
